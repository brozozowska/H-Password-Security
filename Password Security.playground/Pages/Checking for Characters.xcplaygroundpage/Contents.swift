...
if commonPassword == true {
    print("You've chosen an insecure password. Your password must contain at least one digit and one punctuation symbol")
} else if containsDigit == true && containsPunctuation == true {
    print("You've chosen a secure password")
} else {
    print("Your password must contain at least one digit and one punctuation symbol")
}
/*:
